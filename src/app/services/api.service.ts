...
const DOT_NET_API_URL = 'http://localhost:7223/api/';//'https://dotnet-v4itmarathon-prod.azurewebsites.net/api/';
const PYTHON_API_URL = 'http://localhost:8000/api/';//'https://python-v4-itmarathon-prod.azurewebsites.net/api/';
